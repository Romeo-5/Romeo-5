...
## 🔬 What I'm Working On
- 🎮 Hierarchical RL agent for Minecraft using PPO/DQN with novelty-based skill selection
- 🎬 Real-time video style transfer with temporal consistency and distributed GPU training
- 🦾 Autonoumous navigation and simulation environments for robotic manipulation at USC's ISI Polymorphic Robotics Lab
...
## 🛠️ Tech Stack
**Languages:** Python • C++ • CUDA • JavaScript/TypeScript • SQL  
**ML/AI:** PyTorch • TensorFlow • Hugging Face • LangChain • OpenCV • Stable-Baselines3  
**GPU Computing:** CUDA • Multi-GPU Training (DDP) • Mixed Precision (AMP)  
**Tools:** FastAPI • Docker • Git • CI/CD • React • TensorBoard  
**Focus Areas:** Computer Vision • LLMs • RAG • Reinforcement Learning • Robotics • Deep Learning
...
- 🎮 **Minecraft-HRL-Agent**: Hierarchical RL agent using PPO/DQN with UCB-style novelty heuristics for intelligent skill selection
...
- 📧 rjnickel@usc.edu
- 🌐 Los Angeles, CA | Open to Summer 2026 ML/AI internships

---
💡 *Interested in ML engineering, computer vision, reinforcement learning, robotics, and production AI systems*
